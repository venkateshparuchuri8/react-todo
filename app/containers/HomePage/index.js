...
// import file from './downloads/offlineEditor.exe';
import { mocData, deviceList, opnData } from './constants';
...
class DeviceManagement extends Component {
  ...
  getReceipes(type) {
    ...
    this.setState({
      ...
      opnSearch: mocData,
      sgnSearch: mocData,
      filterPayload: this.getFilterPayload(mocData),
    });
  }
